...
pandoc.table(summary(bank), style="rmarkdown", caption="Bank Summary")

invisible(str(bank)) # show the content of each categories 
...
```{r, echo=FALSE}
# Category: Education
kbl(summary(bank$education), booktabs = TRUE)
...
kbl(edu_, booktabs = TRUE, caption = "Education Percentage to Subscribe")
...
# Subscription by Consumer Confidence Index
